...
public class augustTable extends JFrame implements ListSelectionListener {
    ...
    public augustTable() throws IOException {
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setLayout(new GridBagLayout());
        setSize(800, 550);
        setResizable(false);
        setLocationRelativeTo(null);
        setTitle("Employee Records - August");
        ...
        view.addActionListener(e -> {
            ...
            if (selectRow >= 0) {
                if (selectRow == 0) {
                    ...
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(126).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(127).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(128).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(129).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(130).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(131).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(132).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(133).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(134).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(135).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(136).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(137).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(138).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(139).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(140).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(141).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(142).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(143).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(144).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(145).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(146).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(147).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(148).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(149).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(150).getCell(6)));
        ...
        update.addActionListener(e -> {
            ...
            if (selectRow >= 0 && selectColumn == 0) {
                ...
                JOptionPane.showMessageDialog(augustTable.this, "Please select a tab to update.");
            }
        });
        ...
        delete.addActionListener(e -> {
            ...
            if (selectedRow >= 0) {
                int confirm = JOptionPane.showConfirmDialog(augustTable.this,
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(augustTable.this, "Employee deleted successfully.");

                    // Clear the input fields
                    clearInputFields();
                }
            } else {
                JOptionPane.showMessageDialog(augustTable.this, "Please select an employee to delete.");
            }
        });
        ...
        gbc.gridy = 0;
        gbc.gridx = 0;
        JLabel january = new JLabel("|August|");
