...
public class februaryTable extends JFrame implements ListSelectionListener {
    ...
    public februaryTable() throws IOException {
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setLayout(new GridBagLayout());
        setSize(800, 550);
        setResizable(false);
        setLocationRelativeTo(null);
        setTitle("Employee Records - February");
        ...
        view.addActionListener(e -> {
            ...
            if (selectRow >= 0) {
                if (selectRow == 0) {
                    ...
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(26).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(27).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(28).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(29).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(30).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(31).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(32).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(33).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(34).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(35).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(36).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(37).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(38).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(39).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(40).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(41).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(42).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(43).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(44).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(45).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(46).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(47).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(48).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(49).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(50).getCell(6)));
        ...
        update.addActionListener(e -> {
            ...
            if (selectRow >= 0 && selectColumn == 0) {
                ...
                JOptionPane.showMessageDialog(februaryTable.this, "Please select a tab to update.");
            }
        });
        ...
        delete.addActionListener(e -> {
            ...
            if (selectedRow >= 0) {
                int confirm = JOptionPane.showConfirmDialog(februaryTable.this,
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(februaryTable.this, "Employee deleted successfully.");

                    // Clear the input fields
                    clearInputFields();
                }
            } else {
                JOptionPane.showMessageDialog(februaryTable.this, "Please select an employee to delete.");
            }
        });
        ...
        gbc.gridy = 0;
        gbc.gridx = 0;
        JLabel january = new JLabel("|February|");
