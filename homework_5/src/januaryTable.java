...
public class januaryTable extends JFrame implements ListSelectionListener {
    ...
    public januaryTable() throws IOException {
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setLayout(new GridBagLayout());
        setSize(800, 550);
        setResizable(false);
        setLocationRelativeTo(null);
        setTitle("Employee Records - January");
        ...
        view.addActionListener(e -> {
            ...
            if (selectRow >= 0) {
                if (selectRow == 0) {
                    ...
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(1).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(2).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(3).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(4).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(5).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(6).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(7).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(8).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(9).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(10).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(11).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(12).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(13).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(14).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(15).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(16).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(17).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(18).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(19).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(20).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(21).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(22).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(23).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(24).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(25).getCell(6)));
        ...
        update.addActionListener(e -> {
            ...
            if (selectRow >= 0 && selectColumn == 0) {
                ...
                JOptionPane.showMessageDialog(januaryTable.this, "Please select a tab to update.");
            }
        });
        ...
        delete.addActionListener(e -> {
            ...
            if (selectedRow >= 0) {
                int confirm = JOptionPane.showConfirmDialog(januaryTable.this,
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(januaryTable.this, "Employee deleted successfully.");

                    // Clear the input fields
                    clearInputFields();
                }
            } else {
                JOptionPane.showMessageDialog(januaryTable.this, "Please select an employee to delete.");
            }
    });
        ...
        gbc.gridy = 0;
        gbc.gridx = 0;
        JLabel january = new JLabel("|January|");
