    ...
    public mayTable() throws IOException {
        ...
        update.addActionListener(e -> {
            ...
            if (selectRow >= 0 && selectColumn == 0) {
                ...
                JOptionPane.showMessageDialog(mayTable.this, "Please select a tab to update.");
            }
        });
        ...
        delete.addActionListener(e -> {
            ...
            if (selectedRow >= 0) {
                int confirm = JOptionPane.showConfirmDialog(mayTable.this,
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(mayTable.this, "Employee deleted successfully.");

                    // Clear the input fields
                    clearInputFields();
                }
            } else {
                JOptionPane.showMessageDialog(mayTable.this, "Please select an employee to delete.");
            }
        });
