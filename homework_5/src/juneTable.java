...
public class juneTable extends JFrame implements ListSelectionListener {
    ...
    public juneTable() throws IOException {
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setLayout(new GridBagLayout());
        setSize(800, 550);
        setResizable(false);
        setLocationRelativeTo(null);
        setTitle("Employee Records - June");
        ...
        view.addActionListener(e -> {
            ...
            if (selectRow >= 0) {
                if (selectRow == 0) {
                    ...
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(76).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(77).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(78).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(79).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(80).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(81).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(82).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(83).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(84).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(85).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(86).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(87).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(88).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(89).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(90).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(91).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(92).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(93).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(94).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(95).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(96).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(97).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(98).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(99).getCell(6)));
                    ...
                    sndFrame.setVisible(true);
                    sndFrame.setVisible(true);
                    hoursWorked.setText(String.valueOf(sheetAttendance.getRow(100).getCell(6)));
        ...
        update.addActionListener(e -> {
            ...
            if (selectRow >= 0 && selectColumn == 0) {
                ...
                JOptionPane.showMessageDialog(juneTable.this, "Please select a tab to update.");
            }
        });
        ...
        delete.addActionListener(e -> {
            ...
            if (selectedRow >= 0) {
                int confirm = JOptionPane.showConfirmDialog(juneTable.this,
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(juneTable.this, "Employee deleted successfully.");

                    // Clear the input fields
                    clearInputFields();
                }
            } else {
                JOptionPane.showMessageDialog(juneTable.this, "Please select an employee to delete.");
            }
        });
        ...
        gbc.gridy = 0;
        gbc.gridx = 0;
        JLabel january = new JLabel("|June|");
